        ...
        <div class="card">
            <div class="card-header card-header-icon card-header-rose">
                ...
                <div class="col-md-12 " style="width:250px;">
                    <form class="navbar-form" action="{{route('employee.patientHistory.search',$patient_id)}}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a
                                    href="{{route('employee.patientManagment.result',['analysis_id'=>$req->analysis[0]->analysis_id,'patient_id'=>$patient_id,'analysis_required_id'=>$req->id])}}">
