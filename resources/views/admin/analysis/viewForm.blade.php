    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <div class="card-body">
                    @isset($analysis)
                    <form method="post" action="{{route('admin.showAnalysis.updateForm',$analysis->analysis_id)}}">
                        @csrf
                        <div class="row" >
                            <div class="col-md-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            @isset($count_chick)
                                            @if($count_chick<=0) <a
                                                href="{{route('admin.showAnalysis.deleteInput',['analysis_id'=>$tests->analysis_id,'input_id'=>$tests->input_id])}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="option{{$increaseID}}">
                                            ...
                                            @if($count_chick == 0)
                                            <a
                                                href="{{route('admin.showAnalysis.deleteInputName',['analysis_id'=>$analysis->analysis_id,'input_id'=>$input[$i++]->input_id])}}">
                                                <button type='button' class='btn btn-danger' id='remove'>-</button>
                                            </a>
                                            @endif
                                            @endisset
                                            ...
                                            <div class='removeOption'>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="form-group">
                                                        <a href="{{route('admin.showAnalysis.deleteOption',['analysis_id'=>$analysis->analysis_id,'input_id'=>$input[$l]->input_id,'option_id'=>$data_option[$l][$key2]])}}">
                    ...
                    <form method="get" action="{{route('admin.analysis.addInputs',$analysis->analysis_id)}}">
                        @csrf
                        <button type="submit" class="btn btn-rose" data-toggle="tooltip" data-placement="top"
