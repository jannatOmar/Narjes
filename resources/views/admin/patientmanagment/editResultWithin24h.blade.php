        ...
        <div class="col-md-12" style="margin: auto;">
            <div class="card" style="width: 90%;">
                ...
                <form style="padding:30px" method="post"
                      action="{{route('admin.patient.updateResult',['analysis_required_id'=>$analysis_required_id,'patient_id'=>$patient->patient_id])}}">
                    @csrf
                    <div class="row">
                        @isset($patient)
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly class="form-control" name="gender" value="{{$patient->gender}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" readonly name="analysis_name"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type='text' name='Data[]' class="form-control" value="{{$results[$key]->data}}">
                               ...
                               @if($patient->gender=="female")
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type='text' readonly name='min_normal[]'  class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type='text' readonly name='input_Op[]' class="form-control"
                                                   value="{{$key1}}">
                                            @error("input_Op.$key")
                                            <span class="text-danger">{{$message}} </span>
                                            @enderror
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <select class="selectpicker" name="Data_Op[]" data-style="select-with-transition" title="Result" data-size="7">
                                                <option disabled>Choose Result</option>
                                                @foreach($op1 as $key2 => $option_name)
                                                    <option value="{{$option_name->option_name}}" @if($option_name->option_name == $results[$key+$index]->data) selected @endif >{{$option_name->option_name}}</option>
                                                @endforeach
                                            </select>
                                            @error("Data_Op.$key")
                                            <span class="text-danger">{{$message}} </span>
