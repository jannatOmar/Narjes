        ...
        <div class="card" style="width: 90%;">
            ...
            <div class="card-header card-header-icon card-header-rose">
                ...
                <div class="card-body">
                    ...
                    <form method="get" action="{{route('admin.patientManagment.filter')}}">
                        @csrf
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="nameid" name="patient_name" class="selectpicker"
                                    ...
                                    <option value="{{$p->PATIENTNAME}}" selected
                                        @if($p->PATIENTNAME==$p_name)selected    @endif>{{$p->PATIENTNAME}}
                                    </option>
                                    @else
                                ...
                                @enderror
                                <br>
                                <a href="{{route('admin.patientManagment.create')}}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="nameDid" name="doctor_name" class="selectpicker"
                                    ...
                                    @foreach($doctor as $p)
                                    @if(@isset($d_name))
                                    <option value="{{$p->DOCTORNAME}}"
                                     @if($p->DOCTORNAME==$d_name)selected @endif >
                                     {{$p->DOCTORNAME}}
                                     </option>
                                    @else
