...
<div class="col-md-12">
        <div class="card">
            ...
            <div class="col-md-12 " style="width:250px;">
                    <form class="navbar-form" action="{{route('admin.patientHistory.search',$patient_id)}}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a
                                    href="{{route('admin.patientManagment.result',['analysis_id'=>$req->analysis[0]->analysis_id,'patient_id'=>$patient_id,'analysis_required_id'=>$req->id])}}">
                                    <button type="button" rel="tooltip" class="btn btn-success">
                                        Show Result
                                    </button>
                                </a>
                                @if($req->active_update->status==1)
                                <a
                                    href="{{route('admin.patient.editResult',['analysis_id'=>$req->analysis[0]->analysis_id,'patient_id'=>$patient_id,'analysis_required_id'=>$req->id])}}">
                                    <button type="button" name="edit" rel="tooltip" class="btn btn-success">
                                        Edit within 24h
                                    </button>
