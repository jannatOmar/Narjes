            ...
            <div class="card-body">
                <form class="form" method="post" action="{{route('admin.userManagment.update',$user->id)}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="f_name" value="{{$user->f_name}}" class="form-control"
                                    @if($user->end_date)disabled @endif>
                                @error('f_name')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="password" @if($user->end_date)disabled
                                @endif value="" >
                                @error('password')
                                <span class="text-danger">{{$message}} </span>
                                @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" disabled class="form-control" name="role_name"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label style="color:darkgrey;font-size:12px">End date</label>
