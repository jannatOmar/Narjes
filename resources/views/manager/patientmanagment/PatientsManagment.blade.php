    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="col-md-12 float-right" style="width:250px;">
                <form class="navbar-form" method="get" action="{{route('manager.patient.search')}}">
                    @csrf
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-actions text-center">
                                    <a href="{{route('manager.patientManagment.edit',$index->patient_id)}}">
                                        <button type="button" rel="tooltip" class="btn btn-success">
                                            <i class="material-icons">edit</i>
                                        </button>
                                    </a>
                                    <a href="{{route('manager.patientManagment.history',$index->patient_id)}}">
