            ...
            <div class="card-header card-header-rose card-header-icon">
                ...
                <div class="card-body">
                    ...
                    <form class="navbar-form col-lg-12 form" method="post"
                        action="{{route('manager.analysis.storeInputs',$analysis->analysis_id)}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
    ...
    $(document).on('click', '#add', function() {
        ...
        if (selectedType == "text") {
            row = " <div class='remove'>" +
                ...
                "<div class='col-md-3'>" +
                "<div class='form-group'>" +
                "<label class='bmd-label-floating'>Male_Range</label> " +
                ...
                "<div class='col-md-3'>" +
                "<div class='form-group'>" +
                "<label class='bmd-label-floating'>Female_Range</label> " +
