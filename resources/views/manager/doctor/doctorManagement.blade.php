    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="col-md-12" style="width:250px;   ">
                <form class="navbar-form" method="get" action="{{route('manager.doctor.search')}}">
                    <div class="input-group no-border float-right">
                        <input type="text" name="name" value="@isset($q) {{$q}} @endisset" class="form-control" placeholder="Search..."
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('manager.doctor.edit',$d->doctor_id)}}">
