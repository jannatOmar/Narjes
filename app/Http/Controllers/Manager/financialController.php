...
class financialController extends Controller
{
    public function index (){
        ...
        return view('manager.financialDetails.laboratoryAnalysisPrice', compact('analysis'));
    }
    ...
    public function search(Request $request){
        try{
            ...
            return view('manager.financialDetails.laboratoryAnalysisPrice', compact("analysis","q"));
        }catch(\Exception $ex){
    ...
    public function edit($analysis_id){
        try{
            ...
            return view('manager.financialDetails.editPrice',compact('analysis'));
        }catch(\Exception $ex){
    ...
    public function update(updatePriceRequest $req,$analysis_id){
        try{
            ...
            return redirect()->route('manager.laboratryAnalysisPrice')->with(['success'=>'تم التعديل بنجاح']);
        }catch(\Exception $ex){
